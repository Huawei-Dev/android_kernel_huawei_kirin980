...
/*
DLL????50MHz ?? 200MHz??????????0: 200-170MHz, 1: 170-140MHz, 2: 140-110MHz, 3: 110-80MHz, 4: 80-50MHz, 7: 200-225MHz
*/
...
/*
SDHCI_PHY_CTRL3_OTAPDLYENA:????????????TX????????
SDHCI_PHY_CTRL3_OTAPDLYSEL:TX????????:0-0xF????????0
SDHCI_PHY_CTRL3_ITAPDLYENA:????????????RX????????,????????????????tuning????????
????????????????????????
SDHCI_PHY_CTRL3_ITAPDLYSEL:RX????????:0-0x1F????????0
SDHCI_PHY_CTRL1_DR_TY:????????????????????????????????????????0x0
0x0-50??
0x1-33????????????
0x2-66??
0x3-100????????????
