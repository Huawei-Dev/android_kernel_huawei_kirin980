...
typedef struct
{
    oal_uint32  bit_uapsd                          : 1,
                ...
                bit_icmp_filter                    : 1,                 /* rx????icmp??????filter*/
                bit_resv                           : 2;
}mac_cap_flag_stru;
...
#endif
    oal_uint32                                    ul_resv[10];/* ????????????????ROM??,?????????? */
    oal_bool_enum_uint8                           en_dot11VHTExtendedNSSBWCapable; /* VHT cap Extended NSS BW Support???????????? */
    mac_vap_state_enum_uint8                      en_last_vap_state;               /* wlan0 ??????????????VAP ???????????????? */
    oal_uint8                          auc_rsv[2];
...
typedef struct
{
    ...
    oal_uint8                           bit_bss_include_rrm_ie :1; /* ??????bss ????rrm ie */
...
typedef struct
{
    ...
    oal_fem_lp_state_enum_uint8 en_fem_lp_enable;             /* ????????fem??????????*/
    oal_int8                    c_fem_spec_value;             /* fem spec??????*/
