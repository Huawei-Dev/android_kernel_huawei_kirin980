...
OAL_STATIC oal_void original_value_for_nvram_params(oal_void)
{
    ...
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_IQ_LPF_LVL] = 0x00001111;
}
...
#ifdef _PRE_WLAN_FEATURE_NRCOEX
    /* 5g nr coex */
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_ENABLE]                  = 0;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE0_FREQ]              = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE0_40M_20M_GAP0]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE0_160M_80M_GAP0]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE0_40M_20M_GAP1]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE0_160M_80M_GAP1]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE0_40M_20M_GAP2]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE0_160M_80M_GAP2]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE0_SMALLGAP0_ACT]     = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE0_GAP01_ACT]         = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE0_GAP12_ACT]         = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE0_RXSLOT_RSSI]       = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE1_FREQ]              = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE1_40M_20M_GAP0]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE1_160M_80M_GAP0]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE1_40M_20M_GAP1]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE1_160M_80M_GAP1]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE1_40M_20M_GAP2]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE1_160M_80M_GAP2]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE1_SMALLGAP0_ACT]     = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE1_GAP01_ACT]         = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE1_GAP12_ACT]         = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE1_RXSLOT_RSSI]       = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE2_FREQ]              = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE2_40M_20M_GAP0]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE2_160M_80M_GAP0]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE2_40M_20M_GAP1]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE2_160M_80M_GAP1]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE2_40M_20M_GAP2]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE2_160M_80M_GAP2]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE2_SMALLGAP0_ACT]     = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE2_GAP01_ACT]         = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE2_GAP12_ACT]         = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE2_RXSLOT_RSSI]       = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE3_FREQ]              = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE3_40M_20M_GAP0]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE3_160M_80M_GAP0]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE3_40M_20M_GAP1]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE3_160M_80M_GAP1]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE3_40M_20M_GAP2]      = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE3_160M_80M_GAP2]     = 0x00000000;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE3_SMALLGAP0_ACT]     = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE3_GAP01_ACT]         = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE3_GAP12_ACT]         = 0xFFFFFFFF;
    g_al_host_init_params_etc[WLAN_CFG_INIT_NRCOEX_RULE3_RXSLOT_RSSI]       = 0xFFFFFFFF;
...
{
    hmac_to_dmac_cfg_custom_data_stru   st_syn_msg;
    nrcoex_cfg_info_stru                st_nrcoex_ini_info;
    ...
    oal_memcopy(puc_data, &st_syn_msg, CUSTOM_MSG_DATA_HDR_LEN);
    oal_memcopy(puc_data + CUSTOM_MSG_DATA_HDR_LEN, &st_nrcoex_ini_info, OAL_SIZEOF(st_nrcoex_ini_info));
...
OAL_STATIC oal_void hwifi_custom_adapt_priv_ini_param_extend(hmac_to_dmac_cfg_custom_data_stru *pst_syn_msg, wlan_cfg_priv_id_uint8 uc_cfg_id, oal_uint8 uc_priv_cfg_value)
{
    switch(uc_cfg_id)
    {
...
OAL_STATIC oal_int32 hwifi_custom_adapt_priv_ini_param(wlan_cfg_priv_id_uint8 uc_cfg_id, oal_uint8 *puc_data, oal_uint32 *pul_len)
{
    ...
    switch(uc_cfg_id)
    {
        ...
        case WLAN_CFG_PRIV_HCC_FLOWCTRL_TYPE:
            hwifi_custom_adapt_hcc_flowctrl_type(&st_syn_msg, &uc_priv_cfg_value);
            break;
        default:
            break;
    }
...
/*****************************************************************************
 ?? ?? ??  : hwifi_config_extend_nvram
 ????????  : nv ram extend function
*****************************************************************************/
OAL_STATIC oal_void hwifi_config_init_iq_lpf_nvram_param(oal_void)
{
    ...
    l_ret = get_cust_conf_int32_etc(INI_MODU_WIFI, g_ast_nvram_config_ini[l_cfg_id].name, &l_nvram_params);
    if (l_ret != INI_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "hwifi_config_init_iq_lpf_nvram_param read id[%d] from ini failed!", l_cfg_id);

        /* ??????????,?????????? */
       l_nvram_params = g_al_nvram_init_params[l_cfg_id];
    }

    /*  5g iq cali lvl  */
    oal_memcopy(g_st_cust_nv_params.auc_5g_iq_cali_lpf_params, &l_nvram_params, NUM_OF_NV_5G_LPF_LVL);

    /* ?????????????? */
    for (l_cfg_id = 0; l_cfg_id < NUM_OF_NV_5G_LPF_LVL; l_cfg_id++){
        if (CUS_VAL_INVALID(g_st_cust_nv_params.auc_5g_iq_cali_lpf_params[l_cfg_id], CUS_IQ_CALI_LPF_MAX, CUS_IQ_CALI_LPF_MIN)){
            g_st_cust_nv_params.auc_5g_iq_cali_lpf_params[l_cfg_id] = CUS_IQ_CALI_LPF_MIN;
        }
    }
}
