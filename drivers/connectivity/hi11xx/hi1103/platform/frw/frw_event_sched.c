...
/*
 * ?? ?? ??  : frw_event_sched_deactivate_queue_no_lock_etc
 * ????????  : ??????????????????????????
 * ????????  : pst_sched_queue: ????????????
 *             pst_event_queue: ????????????
 */
...
/*
 * ?? ?? ??  : frw_event_sched_activate_queue_no_lock_etc
 * ????????  : ??????????????????????????????
 *             ????????????????????????????????????????????????
 * ????????  : past_sched_queue: ????????????
 *             pst_event_queue : ????????????
...
/*
 * ?? ?? ??  : frw_event_sched_pick_next_event_queue_wrr_etc
 * ????????  : ????????????????????????????????
 * ????????  : pst_sched_queue: ????????????
 * ????????  : pst_sched_queue: ????????????
 */
...
/*
 * ?? ?? ??  : frw_event_sched_deactivate_queue_etc
 * ????????  : ??????????????????????????
 * ????????  : pst_sched_queue: ????????????
 *             pst_event_queue: ????????????
 */
...
/*
 * ?? ?? ??  : frw_event_sched_activate_queue_etc
 * ????????  : ??????????????????????????????
 *             ??????????????????????????????????
 * ????????  : past_sched_queue: ????????????
 *             pst_event_queue : ????????????
...
/*
 * ?? ?? ??  : frw_event_sched_pause_queue_etc
 * ????????  : ????????????????
 * ????????  : past_sched_queue: ????????????
 *             pst_event_queue : ????????????
 */
...
/*
 * ?? ?? ??  : frw_event_sched_resume_queue_etc
 * ????????  : ????????????????
 * ????????  : past_sched_queue: ????????????
 *             pst_event_queue : ????????????
 */
