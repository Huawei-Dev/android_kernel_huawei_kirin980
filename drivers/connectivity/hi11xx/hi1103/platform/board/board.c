...
{
    g_board_info_etc.bd_ops.free_board_flowctrl_gpio_etc();
}

int32 board_flowctrl_gpio_init_etc(void)
{
    return g_board_info_etc.bd_ops.board_flowctrl_gpio_init_etc();
}

void board_flowctrl_irq_init_etc(void)
{
    g_board_info_etc.flowctrl_irq = oal_gpio_to_irq(g_board_info_etc.flowctrl_gpio);
}
...
int32 board_func_init(void)
{
    ...
    switch (g_board_info_etc.chip_nr)
    {
        ...
        case BOARD_VERSION_HI1103:
            ...
            g_board_info_etc.bd_ops.free_board_flowctrl_gpio_etc   =hi1103_free_board_flowctrl_gpio_etc;
            ...
            g_board_info_etc.bd_ops.board_flowctrl_gpio_init_etc   =hi1103_board_flowctrl_gpio_init_etc;
