...
oal_void *5610_gpio1 = OAL_PTR_NULL; /* 0x10106000???? */
oal_void *5610_gpio2 = OAL_PTR_NULL; /* 0x10108000???? */
#endif
#ifdef _PRE_WLAN_FEATURE_PCIE_ADAPT_5116
oal_void *5115_sys_ctl1 = OAL_PTR_NULL; /* v200 5116 pcie1??sys ctrl */
#endif
 ...
 * ????????  : 1151 PCIE??????????MEM????????????????????????????????hi1151_pcie_dbi_enable????????1151??DBI??????
 */
