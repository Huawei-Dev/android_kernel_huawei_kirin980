...
/*
 * ?? ?? ??  : oam_report_data_get_global_switch_etc
 * ????????  : ??????????????????????????????????????????????????????????????
 *             ??????????????????????????????????????mips????????????????????
 *             ????????????????????
 * ????????  : en_direction:??????????????????  0 ????  1????
...
/*
 * ?? ?? ??  : oam_report_eth_frame_set_switch_etc
 * ????????  : ??????????????????????
 * ????????  : us_user_idx:??????????id
 *             en_switch  :????????????
 *             en_eth_direction:????????????????
...
/*
 * ?? ?? ??  : oam_report_eth_frame_get_switch_etc
 * ????????  : ??????????????????????
 * ????????  : us_user_idx:??????????id
 *             en_eth_direction:????????????
 *             pen_eth_switch:????????????????
...
/*
 * ?? ?? ??  : oam_report_80211_mcast_set_switch_etc
 * ????????  : ????????80211????\????????????????????????
 * ????????  : en_mcast_direction:????????????????
 *             en_frame_type     :????????????????(??????????)
 *             en_frame_switch   :??????
...
/*
 * ?? ?? ??  : oam_report_80211_mcast_get_switch_etc
 * ????????  : ????????80211????????????
 * ????????  : en_mcast_direction:????????????????
 *             en_frame_type     :????????????????(??????????)
 *             pen_frame_switch  :??????
...
/*
 * ?? ?? ??  : oam_report_80211_ucast_set_switch_etc
 * ????????  : ????80211????????????????
 * ????????  : en_ucast_direction:????????????????
 *             en_frame_type     :????????????????(??????????)
 *             en_frame_switch   :??????
...
/*
 * ?? ?? ??  : oam_report_80211_ucast_get_switch_etc
 * ????????  : ????80211????????????????
 * ????????  : en_ucast_direction:????????????????
 *             en_frame_type     :????????????????(??????????)
 *             pen_frame_switch  :??????
...
/*
 * ?? ?? ??  : oam_report_80211_probe_set_switch_etc
...
/*
 * ?? ?? ??  : oam_report_dhcp_arp_set_switch_etc
 * ????????  : ??????????dhcp??arp??????????
 */
...
/*
 * ?? ?? ??  : oam_report_dhcp_arp_get_switch_etc
 * ????????  : ????????????dhcp??arp??????
 */
...
/*
 * ?? ?? ??  : oam_event_set_specific_type_switch_etc
 * ????????  : ??????????????event??????????
 */
...
/*
 * ?? ?? ??  : oam_ota_set_rx_dscr_switch_etc
 * ????????  : ????????????rx_dscr??????
 */
...
/*
 * ?? ?? ??  : oam_ota_get_rx_dscr_switch_etc
 * ????????  : ????rx??????????????
 */
                                                ...
                                                oam_ota_type_enum_uint8 en_ota_type)
{
    if ((us_param_two_len == 0) || (puc_param_two_addr == NULL)) {
        ...
        oam_dump_buff_by_hex_etc(puc_param_one_addr, us_param_one_len, 4); /* 4??????????4???????????????????? */
    } else {
        /* ?????????????? */
...
/*
 * ?? ?? ??  : oam_report_80211_frame_etc
 * ????????  : ????802.11??
 * ????????  : puc_user_macaddr  :????????mac????
 *             puc_mac_hdr_addr  :mac????????
 *             us_mac_hdr_len    :mac????????
 *             puc_mac_body_addr :mac????????
 *             us_mac_frame_len  :mac????????(????+????)
                                                 ...
                                                 oam_ota_type_enum_uint8 en_ota_type)
{
    ...
    oam_dump_buff_by_hex_etc(puc_dscr_addr, us_dscr_len, 4); /* 4??????????4???????????????????? */
...
/*
 * ?? ?? ??  : oam_report_dft_params_to_sdt_etc
 * ????????  : ??????????????????sdt
 */
