                                             ...
                                             oal_uint16 us_user_idx)
{
    ...
    if (en_frame_type == OAM_USER_TRACK_FRAME_TYPE_MGMT) {
        oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_content_switch = en_frame_switch; /* [false alarm]:?????????????????????? */
        oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_cb_switch = en_cb_switch;         /* [false alarm]:?????????????????????? */
        oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_dscr_switch = en_dscr_switch;     /* [false alarm]:?????????????????????? */
    } else {
        oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_content_switch = en_frame_switch; /* [false alarm]:?????????????????????? */
        oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_cb_switch = en_cb_switch;         /* [false alarm]:?????????????????????? */
        oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_dscr_switch = en_dscr_switch;     /* [false alarm]:?????????????????????? */
                                             ...
                                             oal_uint16 us_user_idx)
{
    ...
    if (en_frame_type == OAM_USER_TRACK_FRAME_TYPE_MGMT) {
        *pen_frame_switch = oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_content_switch; /* [false alarm]:?????????????????????? */
        *pen_cb_switch = oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_cb_switch;         /* [false alarm]:?????????????????????? */
        *pen_dscr_switch = oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_mgmt_ctx[us_user_idx][en_ucast_direction].en_frame_dscr_switch;     /* [false alarm]:?????????????????????? */
    } else {
        *pen_frame_switch = oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_content_switch; /* [false alarm]:?????????????????????? */
        *pen_cb_switch = oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_cb_switch;         /* [false alarm]:?????????????????????? */
        *pen_dscr_switch = oam_mng_ctx.st_user_track_ctx.ast_80211_ucast_data_ctx[us_user_idx][en_ucast_direction].en_frame_dscr_switch;     /* [false alarm]:?????????????????????? */
    }
                                  ...
                                  oam_ota_frame_direction_type_enum_uint8 en_frame_direction)
{
    ...
    if ((uc_mac_hdr_len > WLAN_MAX_FRAME_HEADER_LEN) || (uc_mac_hdr_len < WLAN_MIN_FRAME_HEADER_LEN)) {
        ...
        OAM_WARNING_LOG4(0, OAM_SF_ANY,
                         "{oam_report_80211_frame:HEAD CHECK! hearder_len = %d, frame_len = %d, en_frame_direction = %d, return_addres = 0x%X}",
