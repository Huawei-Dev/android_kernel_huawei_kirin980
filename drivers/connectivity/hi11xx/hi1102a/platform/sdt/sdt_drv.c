...
oal_int32 sdt_drv_send_data_to_wifi(oal_uint8 *puc_param, oal_int32 l_len)
{
    ...
    switch (pc_buf[1]) {
        case OAM_DATA_TYPE_MEM_RW:
            if (OAL_PTR_NULL != oam_wal_func_hook.p_wal_recv_mem_data_func) {
        ...
        case OAM_DATA_TYPE_REG_RW:
            if (OAL_PTR_NULL != oam_wal_func_hook.p_wal_recv_reg_data_func) {
        ...
        case OAM_DATA_TYPE_CFG:
            if (OAL_PTR_NULL != oam_wal_func_hook.p_wal_recv_cfg_data_func) {
        ...
        case OAM_DATA_TYPE_GVAR_RW:
            if (OAL_PTR_NULL != oam_wal_func_hook.p_wal_recv_global_var_func) {
        ...
        case OAM_DATA_TYPE_SAMPLE:
            if (OAL_PTR_NULL != oam_wal_func_hook.p_wal_recv_sample_data_func) {
        ...
        case OAM_DATA_TYPE_AUTOCALI:
            if (OAL_PTR_NULL != oam_wal_func_hook.p_wal_recv_autocali_data_func) {
...
oal_uint32 sdt_drv_netlink_send(oal_netbuf_stru *pst_netbuf, oal_uint32 ul_len)
{
    ...
    if (sdt_drv_mng_entry.ul_usepid == 0) {
        if (0 == (oal_atomic_read(&sdt_drv_mng_entry.ul_unconnect_cnt) % SDT_DRV_REPORT_NO_CONNECT_FREQUENCE)) {
