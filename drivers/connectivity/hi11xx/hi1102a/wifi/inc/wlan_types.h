...
/* type0??????????????0x00??type1??????????????1??0xFF */
/* type2??????????????0x5A??type3??????????????0xA5 */
/* TYPE_NUM??data type???? */
...
typedef enum
  {
    ...
    WLAN_AP_CHIP_OUI_SHENZHEN   = 5,   /* ??????????SHENZHEN */
    WLAN_AP_CHIP_OUI_REALTEKS   = 6,   /* ??????????REALTEKS */
...
/* uc_packet_check_num0????????????????????????????0x00??????*/
/* uc_packet_check_num1????????????????????????????0xFF??????*/
/* uc_packet_check_num2????????????????????????????0x5A??????*/
/* uc_packet_check_num3????????????????????????????0xA5??????*/
typedef struct {
