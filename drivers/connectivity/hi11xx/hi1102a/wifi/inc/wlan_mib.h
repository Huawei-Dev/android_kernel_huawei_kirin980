...
typedef enum
{
    ...
    *************************************************************************/
    ...
    WLAN_CFGID_CFG80211_EXTERNAL_AUTH   = 563,     /* ????SAE???? */
    ...
    WLAN_CFGID_SET_5G_HIGH_BAND_MAX_POW,            /* ????5G??band???????????? */
    ...
    WLAN_CFGID_SET_EVENT_NETBUF_NUM         = 678,            /* ????????????????????netbuf???? */

#if (_PRE_WLAN_FEATURE_PMF != _PRE_PMF_NOT_SUPPORT)
    WLAN_CFGID_PMF_CAP                      = 679,            /* PMF???????? */
#endif
