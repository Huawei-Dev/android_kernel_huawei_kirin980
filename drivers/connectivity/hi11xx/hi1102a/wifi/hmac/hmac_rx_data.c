...
{
    oal_netbuf_stru            *pst_netbuf = OAL_PTR_NULL;         /* ??netbuf????????????????netbuf?????? */
    oal_uint32                  ul_netbuf_num;
    oal_uint32                  ul_ret;
    oal_netbuf_stru            *pst_buf_tmp = OAL_PTR_NULL;        /* ????netbuf??????????while???? */
...
{
    hmac_rx_ctl_stru                   *pst_rx_ctrl = OAL_PTR_NULL;                        /* ????MPDU???????????????? */
...
oal_uint32  hmac_rx_process_data_ap(frw_event_mem_stru *pst_event_mem)
{
    ...
    oal_netbuf_stru                    *pst_netbuf = OAL_PTR_NULL;                     /* ??????????????????MPDU????????netbuf???? */
    oal_netbuf_stru                    *pst_temp_netbuf = OAL_PTR_NULL;                /* ????????????????????????????netbuf???? */
...
{
    frw_event_hdr_stru                 st_event_hdr;
    mac_ieee80211_frame_stru           *pst_frame_hdr = OAL_PTR_NULL;                  /* ????mac???????? */
    mac_ieee80211_frame_stru           *pst_copy_frame_hdr = OAL_PTR_NULL; /* ????mac???????? */
    ...
    oal_netbuf_stru                    *pst_netbuf = OAL_PTR_NULL;                     /* ??????????????????MPDU????????netbuf???? */
    oal_netbuf_stru                    *pst_temp_netbuf = OAL_PTR_NULL;                /* ????????????????????????????netbuf???? */
    oal_netbuf_stru                    *pst_netbuf_copy = OAL_PTR_NULL; /* ??????????????copy */
