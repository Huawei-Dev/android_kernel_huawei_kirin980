...
/*************************************************************
??????????int check_cosid_valid(unsigned int cos_id, hisee_img_header *p_img_header)
??????????????cos_id??????????????????????????hisee.img??????????????????????cos_id????????
??????
??????cos_id:cos_id??p_img_header:????????????????????????hisee.img????????????????
??????????
????????1:cos_id????OK??0:cos_id??????OK
??????????????????????????hisee.img????????????????????
?????????? ??
*************************************************************/
...
/*************************************************************
??????????int second_check_newest_cosimage(unsigned int cos_id, const multicos_upgrade_info *curr_ptr)
??????????????cos_id??????cos??????????????????????????????cos????(????cos????????????????????????)
??????
??????cos_id:????cos????id??curr_ptr:??????????????????hisee_img??????cos??????????????????????????????????
??????????
????????HISEE_TRUE:????cos_id??????cos??????????????HISEE_FALSE:????cos_id??????cos????????????
?????????? ??
?????????? ??
