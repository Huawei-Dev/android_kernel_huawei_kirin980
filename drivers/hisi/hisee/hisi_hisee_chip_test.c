...
#ifdef CONFIG_HISEE_SUPPORT_MULTI_COS
/*************************************************************
??????????int cos_flash_image_upgrade_func(void *buf, unsigned int factory_test_flg)
??????????????cos_flash????????????????????????????????cos_flash??????????encos????????????hisee????
??????
??????buf:??????????????????cos_id??process_id????????????????????NULL(????????)??
	  factory_test_flg:??????cos flash????????????????????????????adb shell????????HISEE_FACTORY_TEST_VERSION
	  ??????????????????
??????????
????????HISEE_OK:cos_flash??????????????????HISEE_OK:cos_flash????????????
??????????/mnt/hisee_fs/??????????cos_flash.img
?????????? ??
*************************************************************/
...
??????????????cos_flash??????????????????Hisee coe????cos flash????
??????
????????
??????????
????????HISEE_OK:cos_flash??????????????????HISEE_OK:cos_flash????????????
??????????cos_flash_image_upgrade_func()??????????????????cos_flash????????
			??????????????????DDR??????????????????????????????????????
?????????? ??
*************************************************************/
...
/*************************************************************
??????????int sm_write_rpmb_key_process(void *buf)
??????????hisee SM????????hisee ????rpmbkey??????
??????
??????????
??????????
????????HISEE_OK:SM????????hisee ????rpmbkey??????SM????????hisee ????rpmbkey????
??????????cos_flash??????cos??????????????????????????hisee????????????cos_flash????
?????????? ??
*************************************************************/
...
/*************************************************************
??????????int load_cos_flash_do_factory_test(void *buf)
????????????????????cos flash??????????????????????????????
		  ????cos flash??????????cos flash????????????????????????????????????
		  ??hisee rpmb region??rpmbkey??????run_hisee_nvmformat()????NVM format????????
??????
??????buf:??????????????????cos_id??process_id????????????????????NULL(????????)??
	  para:????????cos flash??????DM??????SM????????????????
??????????
????????HISEE_OK:??????????cos flash??????????????????????????????????
		????HISEE_OK:??????????cos flash????????????????????????????????
??????????
