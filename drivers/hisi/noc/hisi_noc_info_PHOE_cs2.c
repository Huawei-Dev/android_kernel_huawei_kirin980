...
struct noc_mid_info noc_mid_PHOE_cs2[] = {
	...
	{0, 0x10, 0x003f, 0x15, "AP_maa"},
	{0, 0x13, 0x003f, 0x20, "L2CPU_CFG/L2CPU_L2C"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x21, "L2HAC_CIPHER"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x22, "LATENCY_MONITOR"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x23, "CPU5G_CFG/CPU5G_L2C"},  /*noc_modem_mst,*/
	{0, 0x1D, 0x003f, 0x24, "AP_SPE"},
	{0, 0x13, 0x003f, 0x25, "L2HAC_EICC0"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x26, "L2HAC_EICC1"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x27, "LL1C_BBE0"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x28, "LL1C_BBE1"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x29, "LL1C_EDMA0"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x2A, "LL1C_EDMA1"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x2B, "LL1C_EICC0"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x2C, "LL1C_EICC1"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x2D, "LL1C_FASTDMA"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x2E, "BBP5G_FASTDMA"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x2F, "CPU5G_EICC0"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x30, "BBP5G_COMDMA2SOC"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x31, "BBP5G_COMDMA2DDR"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x32, "BBP5G_PDE_PDS"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x33, "BBP5G_PDE_CSI"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x34, "BBIC"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x35, "BBP5G_NLDL2SOC"},  /*noc_modem_mst,*/
	...
	{0, 0x13, 0x003f, 0x18, "LL1C_BBE2/NXDSP"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x38, "BBP5G_NLDL2DDR"},  /*noc_modem_mst,*/
	...
	{0, 0x13, 0x003f, 0x1B, "MDM5G_EDMA0/EDMA0"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x3B, "MDM5G_EDMA1/EDMA1"},  /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x1C, "BBP5G_UL/HARQ_L"},    /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x3C, "HARQ_H"},    /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x1D, "UPACC"}, /*noc_modem_mst,*/
	{0, 0x13, 0x003f, 0x3D, "MDM5G_RSR_ACC/RSR_ACC"}, /*noc_modem_mst,*/
