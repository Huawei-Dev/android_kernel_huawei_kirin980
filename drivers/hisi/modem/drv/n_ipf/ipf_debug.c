...
struct ipf_mannul_unit ipf_mannul[] = {
    {SYMBOL(bsp_ipf_show_status),   "?????? ???? IPF????????\n"},
    {SYMBOL(bsp_ipf_info),      "????1:????????  0????????1??????\n"},
    {SYMBOL(bsp_ipf_bdinfo),    "????1:????????  ????2:BD????\n"},
    {SYMBOL(bsp_ipf_rdinfo),    "????1:????????  ????2:RD????\n"},
    {SYMBOL(bsp_ipf_adinfo),    "????1:????????  ????2:AD????????3:AD ????????0????,1????\n"},
    {SYMBOL(bsp_ipf_dump_bdinfo),   "????1:????????\n"},
    {SYMBOL(bsp_ipf_dump_rdinfo),   "????1:????????\n"},
    {SYMBOL(bsp_ipf_dump_adinfo),   "????1:????????\n"},
    {SYMBOL(ipf_enable_dl_time_stamp),  "????1:0-disable, 1-enable\n"},
    {SYMBOL(ipf_clear_time_stamp),  "??????????????\n"},
    {SYMBOL(ipf_dump_time_stamp),   "Linux:??????????, vxWorks:??????????\n"},
    {SYMBOL(bsp_ipf_mem),   "???????????? IPF????????"},
    {SYMBOL(ipf_enable_dl_time_stamp),    "????1:0-disable, 1-enable\n"},
    {SYMBOL(ipf_clear_time_stamp),  "?????? ??????????????"},
    {SYMBOL(ipf_dump_time_stamp),  "?????? ??????????????"},
    {SYMBOL(bsp_ipf_ad_status),  "?????? ????AD????"},
};
