...
struct grp_load_mode {
	bool freq_enabled; /* True: freq to GRP_TIME, False: freq to CPU_TIME */
	bool util_enabled; /* True: account GRP_UTIL, False: don't account */
};
...
struct related_thread_group {
	...
	/* record cpu_time in grp ?
	 * if True : the Task' cpu usage will account in grp->cpu_time
	 * if False : the Task' cpu usage will account in rq
	 *
	 * Task's cpu usage is accounted in:
	 * grp->cpu_time[cpu]->curr/prev_runnable_sum,
	 * when its ->grp is !NULL and account_cpu_time is True
	 */
	bool account_cpu_time;
